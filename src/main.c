...
static void main_window_load(Window *window) {
  ...
  s_timedate_layer = text_layer_create(GRect(0, 5, 144, 25));
  text_layer_set_background_color(s_timedate_layer, GColorClear);
  text_layer_set_text_color(s_timedate_layer, GColorWhite);
  ...
  s_weather_layer = text_layer_create(GRect(0, 136, 144, 25));
